...
Because the new version of Rails automagically includes all of the stylesheets in the root of your stylesheet folder, active_stylesheets houses the browser specific version of your stylesheet in the /browser folder inside of stylesheets. *If you happen to have a controller called the browser_controller, this could cause a conflict!*
